...
var tulisanBawah = document.getElementsByTagName("h3")[1];
if (update(Solar)) {
  tulisanBawah.innerHTML = "Solar Energy Source Growth Rate from 2012 to 2021";
  console.log("solar");
} else if (update(Gas)) {
  tulisanBawah.innerHTML = "Gas Energy Source Growth Rate from 2012 to 2021";
  console.log("users");
}
